...
def write_template(path: Path = OUT) -> None:
    sheets = {
        ...
        "贮箱基本参数": pd.DataFrame([
            ["子级", 1, 1, "一级氧化剂箱", "等效圆柱", 1.2, 4.0, 1140, 5, 50, 6000, 300, 6000, 2.0, 0.0, 90000, 0.0, 45, 0, 0, 0, 120, 125, 0, 4.0, 18.1, 2.0, 90000, "示例"],
            ["子级", 1, 2, "一级燃料箱", "等效圆柱", 1.1, 3.8, 810, 4, 35, 3500, 200, 3500, 1.9, 0.0, 50000, 0.0, 32, 0, 0, 0, 120, 125, 0, 3.8, 14.4, 1.9, 50000, "示例"],
