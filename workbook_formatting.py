...
HEADER_COMMENTS = {
    ...
    "关机时间tb": "发动机关机时间，单位 s。",
    "分离时间ts": "该级/助推器分离时间。按 QJ 标准，程序采用 t > ts 时剔除。",
    "抛离时间": "可抛部件抛离时间，单位 s。",
    "推进剂密度rho_phi": "推进剂密度，单位 kg/m^3，必须大于0。",
    "气体密度rho_g": "增压气体密度，单位 kg/m^3。",
    "秒流量mdot": "推进剂消耗质量流量，单位 kg/s。",
    "加注量Mf": "发动机点火前贮箱内可变质量，单位 kg。",
    "关机剩余量Mr": "发动机关机后剩余可变质量，单位 kg。",
    "启动后剩余量Mef": "启动活门打开后的剩余可变质量，工作段按 Mef - mdot*(t-tf) 计算。",
    "加注后Xf": "点火前加注状态可变质量在贮箱局部坐标系下的 X 坐标；留空则按 Mf 查液位表。",
    "关机后Xr": "关机后剩余状态可变质量在贮箱局部坐标系下的 X 坐标；留空则按 Mr 查液位表。",
    "加注后Jyf": "点火前加注状态可变质量绕局部 Y 轴中心主惯量；留空则按 Mf 查液位表。",
    "关机后Jyr": "关机后剩余状态可变质量绕局部 Y 轴中心主惯量；留空则按 Mr 查液位表。",
